export default class StcSquadCpuCompletion {
    id: number;
    group_id: number;
    lv: number;
    ...
    static fromArray(array: (number | bigint | string)[]): StcSquadCpuCompletion {
        return new StcSquadCpuCompletion(array[0] as number,
                                         array[1] as number,
                                         array[2] as number,
                                         array[3] as number,
                                         array[4] as number,
